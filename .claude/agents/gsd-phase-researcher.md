...
@/Users/h.grosse-plankermann/development/sideprojects/gsd/.claude/get-shit-done/references/thinking-models-research.md
...
```bash
node "/Users/h.grosse-plankermann/development/sideprojects/gsd/.claude/get-shit-done/bin/gsd-tools.cjs" graphify query "<capability-keyword>" --budget 1500
```
