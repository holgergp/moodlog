...
<required_reading>
Read `/Users/h.grosse-plankermann/development/sideprojects/gsd/.claude/get-shit-done/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
