...
<required_reading>
@/Users/h.grosse-plankermann/development/sideprojects/gsd/.claude/get-shit-done/references/ai-frameworks.md
@/Users/h.grosse-plankermann/development/sideprojects/gsd/.claude/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read /Users/h.grosse-plankermann/development/sideprojects/gsd/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/h.grosse-plankermann/development/sideprojects/gsd/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/h.grosse-plankermann/development/sideprojects/gsd/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/h.grosse-plankermann/development/sideprojects/gsd/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/h.grosse-plankermann/development/sideprojects/gsd/.claude/agents/gsd-eval-planner.md for instructions.
