...
- **Global scope**: `/Users/h.grosse-plankermann/development/sideprojects/gsd/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/h.grosse-plankermann/development/sideprojects/gsd/.claude/notes/`)
...
2. Glob `/Users/h.grosse-plankermann/development/sideprojects/gsd/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/h.grosse-plankermann/development/sideprojects/gsd/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/h.grosse-plankermann/development/sideprojects/gsd/.claude/notes/` — works in any directory
