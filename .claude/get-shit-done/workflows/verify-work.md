...
<template>
@/Users/h.grosse-plankermann/development/sideprojects/gsd/.claude/get-shit-done/templates/UAT.md
</template>
...
Read and follow `/Users/h.grosse-plankermann/development/sideprojects/gsd/.claude/get-shit-done/workflows/transition.md`.
...
```bash
node "/Users/h.grosse-plankermann/development/sideprojects/gsd/.claude/get-shit-done/bin/gsd-tools.cjs" audit-open --json 2>/dev/null
```
...
- Follow @/Users/h.grosse-plankermann/development/sideprojects/gsd/.claude/get-shit-done/workflows/diagnose-issues.md
