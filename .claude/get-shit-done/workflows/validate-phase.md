...
```
Task(
  prompt="Read /Users/h.grosse-plankermann/development/sideprojects/gsd/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/h.grosse-plankermann/development/sideprojects/gsd/.claude/get-shit-done/templates/VALIDATION.md`
