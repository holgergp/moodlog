...
```bash
node "/Users/h.grosse-plankermann/development/sideprojects/gsd/.claude/get-shit-done/bin/gsd-tools.cjs" audit-open 2>/dev/null
```
...
**If doesn't exist:** Create from template at `/Users/h.grosse-plankermann/development/sideprojects/gsd/.claude/get-shit-done/templates/retrospective.md`.
